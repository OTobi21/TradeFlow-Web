  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-950 flex items-center justify-center p-6">
      ...
      <div className="max-w-md w-full bg-slate-900 border border-red-500/30 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden text-center animate-in fade-in zoom-in duration-300">
        ...
        {/* Content */}
        <h2 className="text-3xl font-bold text-white mb-4 tracking-tight">Unsupported Network</h2>
        ...
        <p className="text-slate-400 mb-8 leading-relaxed">
          ...
          . TradeFlow requires{' '}
          <span className="text-blue-400 font-mono font-bold uppercase">{expectedNetwork}</span> to
          function correctly.
        </p>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-blue-500/5 border border-blue-500/20 rounded-2xl text-blue-300 text-sm">
            Please open your <span className="font-bold text-white">Freighter Wallet</span> and
            switch the network to{' '}
            <span className="font-bold text-white uppercase">{expectedNetwork}</span>.
          </div>
